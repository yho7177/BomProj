	...
	<aside
		...
		<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link navMenu" href="/">
						<div
				...
				<li class="nav-item"><a class="nav-link active" href="/page2?pageNo=1">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
				...
				<li class="nav-item"><a class="nav-link" href="/page3?pageNo=1&searchText=&searchType=">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
