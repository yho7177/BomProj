	...
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				target="_blank"> <img src="../resources/assets/img/logo-ct.png"
				class="navbar-brand-img h-100" alt="main_logo"> <span
				class="ms-1 font-weight-bold">L E G O</span>
			</a>
		</div>
		...
		<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100"
			...
			<ul class="navbar-nav">
				<li class="nav-item mt-3">
					<h6
						class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">BOM
						pages</h6>
				</li>
				<li class="nav-item"><a class="nav-link active navMenu" href="/">
						<div
                  ...
                  <g transform="translate(-1716.000000, -439.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(0.000000, 148.000000)">
						...
						</div> <span class="nav-link-text ms-1">BOM for GUI</span>
				</a></li>
				<li class="nav-item"><a class="nav-link navMenu" href="/page2?pageNo=1">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <g transform="translate(-1869.000000, -293.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g id="office"
						...
						</div> <span class="nav-link-text ms-1">BOM 조회</span>
				</a></li>
				<li class="nav-item"><a class="nav-link navMenu" href="/page3?pageNo=1&searchText=&searchType=">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <g transform="translate(-2169.000000, -745.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(453.000000, 454.000000)">
						...
						</div> <span class="nav-link-text ms-1">제품 등록/조회</span>
				</a></li>
				<li class="nav-item"><a class="nav-link navMenu"
					href="/order">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
							<svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(603.000000, 0.000000)">
						...
						</div> <span class="nav-link-text ms-1">주문서 조회</span>
				</a></li>
				<li class="nav-item"><a class="nav-link navMenu"
					href="../pages/rtl.html">
						<div
				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm"><a
							class="opacity-5 text-dark" href="javascript:;">BOM</a></li>
								...
								<li class="mb-2"><a class="dropdown-item border-radius-md"
									href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img src="../resources/assets/img/team-2.jpg"
								...
								<li class="mb-2"><a class="dropdown-item border-radius-md"
									href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img
													src="../resources/assets/img/small-logos/logo-spotify.svg"
